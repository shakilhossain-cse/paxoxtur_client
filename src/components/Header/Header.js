    ...
    <header className="text-white body-font bg-blue-500">
      <div className="container md:w-5/6 mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center font-semibold ">
          ...
          <NavHashLink className="mr-5 hover:text-gray-900" to="/home#ride">
            Our Ride
          </NavHashLink>
          <NavHashLink className="mr-5 hover:text-gray-900" to="/home#feedback">
            Feedback
          </NavHashLink>
          <Link className="mr-5 hover:text-gray-900" link="/contact">Contact Us</Link>
        </nav>
        <Link className="inline-flex items-center bg-black border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0" to="/login">
          Login
        </Link>
      </div>
    </header>
